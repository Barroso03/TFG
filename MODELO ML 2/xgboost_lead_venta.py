...
results_df.to_csv(r'C:\\TFG\\MODELO ML 2\\RESULTADOS\\LEAD VENTA\\hiperparametros_modelo_lead_trafico.csv', index=False)
...
roc_data.to_csv(r'C:\\TFG\\MODELO ML 2\\RESULTADOS\\LEAD VENTA\\predicciones_venta.csv', 
...
plt.title("Curva ROC")
plt.legend()
plt.savefig(r'C:\\TFG\\MODELO ML 2\\RESULTADOS\\LEAD VENTA\\roc_curve_lead_venta.png')
plt.show()
...
cm_df.to_csv(r'C:\\TFG\\MODELO ML 2\\RESULTADOS\\LEAD VENTA\\confusion_matrix_lead_venta.csv', index=False)
...
plt.savefig(r'C:\\TFG\\MODELO ML 2\\RESULTADOS\\LEAD VENTA\\matriz_confusion_lead_venta.png')
plt.show()
...
importances.to_csv(r'C:\\TFG\\MODELO ML 2\\RESULTADOS\\LEAD VENTA\\importancia_variables_lead_venta.csv', index=False)

# También guardar gráfico opcional
plt.figure(figsize=(10, 5))
sns.barplot(x='Importance', y='Feature', data=importances.head(10))
plt.title("Top 10 Variables Más Importantes")
plt.savefig(r'C:\\TFG\\MODELO ML 2\\RESULTADOS\\LEAD VENTA\\importancia_variables_lead_venta.png')
plt.show()
